...
const centralStoneSpecs = [
  { label: "מתכת", value: "זהב 18K" },
  { label: "צבע היהלום", value: "E–F" },
  { label: "ניקיון", value: "VS1–VS2" },
  { label: "חיתוך", value: "Excellent" },
  { label: "דוח", value: "GIA או IGI לפי האבן הנבחרת" },
];

const matchedPairSpecs = [
  { label: "מתכת", value: "זהב 18K" },
  { label: "שיבוץ", value: "זוג יהלומים תואם בקוטר, צבע וניקיון" },
  { label: "מפרט האבנים", value: "נמסר לפני התשלום, לפי הזוג שנבחר" },
];

const diamondLineSpecs = [
  { label: "מתכת", value: "זהב 18K" },
  { label: "שיבוץ", value: "קו יהלומים תואמים, ארבע שיניים לכל אבן" },
  { label: "מפרט האבנים", value: "נמסר לפני התשלום, לפי הצמיד שנבחר" },
  { label: "אורך", value: "מותאם לאורך היד" },
];
...
export const products: Product[] = [
  {
    ...
    subtitle: "יהלום עגול · שש שיניים · זהב 18K",
  ...
  },
  {
    ...
    gallery: [{ src: "/images/design/products/clean/ring-02-front.jpg", alt: "טבעת פאווה נועה על רקע לבן" }],
    metals: ["white", "yellow"],
  ...
  },
  {
    ...
    gallery: [{ src: "/images/design/products/clean/ring-03-front.jpg", alt: "טבעת שלוש אבנים טריו" }],
    metals: ["white", "yellow"],
  ...
  },
  {
    ...
    description: "חישוק זהב אדום מלוטש וסל עדין בשש שיניים. גוון המתכת מדגיש את הברק הלבן של האבן.",
    priceFrom: 6900,
    image: "/images/design/products/clean/ring-04-front.jpg",
    gallery: [{ src: "/images/design/products/clean/ring-04-front.jpg", alt: "טבעת אלמה בזהב אדום" }],
